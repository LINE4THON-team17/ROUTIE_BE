...
@Tag(
    name = "Friends API",
    description = "사용자 간 팔로우 및 친구 관계 관리 API"
)
@RestController
...
public class FriendsController {
      ...
      responses = {
          @ApiResponse(
              ...
              content = @Content(
                  ...
                  examples = @ExampleObject(name = "friends-example", value = """
                      [
                        {
                          "id": 12,
                          "nickname": "루루",
  ...
  public ResponseEntity<Void> follow(
      @Parameter(description = "팔로우 대상 사용자 ID", example = "42")
  ...
  public ResponseEntity<Void> unfollow(
      @Parameter(description = "언팔로우 대상 사용자 ID", example = "42")
      @PathVariable Long userId
  ) {
      ...
      responses = {
          @ApiResponse(
              ...
              content = @Content(
                  ...
                  examples = @ExampleObject(name = "status-example", value = """
                      {
                        "isFollowing": true,
                        "isFollowedBy": false
                      }
