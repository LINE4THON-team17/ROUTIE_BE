...
import com.example.routie_be.global.dto.ApiError;
...
"id": 12,
"nickname": "루루",
"profileImageUrl": "https://routie.s3.ap-northeast-2.amazonaws.com/profile/rourou.png"
},
{
"id": 34,
"nickname": "티티",
"profileImageUrl": "https://routie.s3.ap-northeast-2.amazonaws.com/profile/tietie.png"
}
]
""")))
    })
                        ...
                        @Content(
                                ...
                                examples =
                                        @ExampleObject(
                                                value =
                                                        """
                  { "status": 400, "message": "이미 팔로우 중입니다.", "data": null }
                """))),
        @ApiResponse(
                responseCode = "404",
                description = "해당 userId가 존재하지 않음",
                content =
                        @Content(
                                mediaType = "application/json",
                                schema = @Schema(implementation = ApiError.class),
                                examples =
                                        @ExampleObject(
                                                value =
                                                        """
                  { "status": 404, "message": "해당 userId가 존재하지 않습니다.", "data": null }
                """)))
    })
                        ...
                        @Content(
                                ...
                                examples =
                                        @ExampleObject(
                                                value =
                                                        """
                  { "status": 400, "message": "팔로우 중이 아닙니다.", "data": null }
                """))),
        @ApiResponse(
                responseCode = "404",
                description = "해당 userId가 존재하지 않음",
