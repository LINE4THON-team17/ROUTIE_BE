...
public class ShareController {
      ...
      responses = {
          @ApiResponse(
              ...
              content = @Content(
                  ...
                  schema = @Schema(implementation = ShareProfileResponse.class),
  ...
  public ResponseEntity<ShareProfileResponse> issueSlug(
      @Parameter(description = "공유 링크를 발급할 사용자 ID (본인만 가능)", example = "7")
  ...
  public ResponseEntity<Long> resolveSlug(
      @Parameter(description = "프로필 공유용 슬러그 문자열", example = "abc123xy")
