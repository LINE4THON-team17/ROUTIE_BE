...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ApiResponse<Object>> handleNotReadable(HttpMessageNotReadableException e) {
    ...
    Object data = exposeDetails ? Map.of("reason", e.getMostSpecificCause().getMessage()) : null;
  ...
  public ResponseEntity<ApiResponse<Object>> handleNoHandler(NoHandlerFoundException e) {
    ...
    Object data = exposeDetails ? Map.of("path", e.getRequestURL(), "method", e.getHttpMethod()) : null;
  ...
  public ResponseEntity<ApiResponse<Object>> handleMethodNotSupported(HttpRequestMethodNotSupportedException e) {
    ...
    Object data = exposeDetails ? Map.of("method", e.getMethod(), "supported", e.getSupportedHttpMethods()) : null;
